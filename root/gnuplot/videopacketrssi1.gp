...
set output "/media/usb/rssi/videopacketrssi1.png"
...
set title "Packets vs rssi wifi 1"
...
plot "/wbc_tmp/videorssi.csv" u 7:($6 > 0 ? $6 : NaN) w points ls 2 t "packets/s",\
"/wbc_tmp/videorssi.csv" u 7:($3 > 0 ? $3 : NaN) w points ls 3 t "lost packets/s",\
"/wbc_tmp/videorssi.csv" u 7:($4 > 0 ? $4 : NaN) w points ls 1 t "bad blocks/s"
